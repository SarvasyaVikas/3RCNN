    ...
    for j in range(len(mult)):
        ...
        #
            ...
            if (rank % 16) == 0:
                ...
                print("fc")
                (networkS, error, filter_matrix, rho, reverseMatrix, zeros) = FunctionalNetwork.FC(networkS, As1[u][rank // 16], alpha, losses[-1], sMaps4)
                ...
                splicewriter.writerow(["NGCT{}_BASE".format(mult[j][0]), i, splice_vals[0], splice_vals[1], splice_vals[2], splice_vals[3]])
                splices.close()
