...
import os
import csv
from FunctionalNetwork_XVI import FunctionalNetwork
...
for i in range(val):
	...
	(networkS, error) = FunctionalNetwork.BP(networkS, As1[i][rank], alpha, losses[-1], sMap4, sMap3, sMap2, sMap1, neurals, psi, stretch)
