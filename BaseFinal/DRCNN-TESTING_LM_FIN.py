...
def data(ptn, start = 0, val = 0):
    ...
    for i in range(start, val - 4):
        vals1 = [float(rows[i][15]), float(rows[i][16]), float(rows[i][17]), float(rows[i][18])]
        vals2 = [float(rows[i + 1][15]), float(rows[i + 1][16]), float(rows[i + 1][17]), float(rows[i + 1][18])]
        vals3 = [float(rows[i + 2][15]), float(rows[i + 2][16]), float(rows[i + 2][17]), float(rows[i + 2][18])]
        vals4 = [float(rows[i + 3][15]), float(rows[i + 3][16]), float(rows[i + 3][17]), float(rows[i + 3][18])]
        vals5 = [float(rows[i + 4][15]), float(rows[i + 4][16]), float(rows[i + 4][17]), float(rows[i + 4][18])]
