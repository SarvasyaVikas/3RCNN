...
def data(ptn, start = 0, val = 0):
    ...
    images = []
    actuals = []
    for i in range(start, val - 4):
        vals1 = [float(rows[i][11]), float(rows[i][12]), float(rows[i][13]), float(rows[i][14])]
        vals2 = [float(rows[i + 1][11]), float(rows[i + 1][12]), float(rows[i + 1][13]), float(rows[i + 1][14])]
        vals3 = [float(rows[i + 2][11]), float(rows[i + 2][12]), float(rows[i + 2][13]), float(rows[i + 2][14])]
        vals4 = [float(rows[i + 3][11]), float(rows[i + 3][12]), float(rows[i + 3][13]), float(rows[i + 3][14])]
        vals5 = [float(rows[i + 4][11]), float(rows[i + 4][12]), float(rows[i + 4][13]), float(rows[i + 4][14])]
