...
def data(ptn):
    rows = []
    with open("REVALS_FC.csv") as csvfile:
...
for epoch in range(epochs):
    ...
    for j in range(1):
        ...
        for i in range(mult[j][1], mult[j][2] - 4):
            ...
            (losses, networkS, CACscore, step) = RCNN.VR(rank, networkS, Is1, As1, mult, j, i, alpha, losses, sMap1, sMap2, sMap3, sMap4, minval, maxval, FOV, CACscore, start, CACactual, scan_start, nn, step, f, "LAD")
