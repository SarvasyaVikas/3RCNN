...
for j in range(len(mult)):
	if rank < 5:
		...
		for i in range(mult[j][1], mult[j][2]):
			...
			k = i - mult[j][1]
			if rank == 0:
				img1 = MPImodifiers.image_masks(Is1[k][0], Is1[k][1], Is1[k][2], Is1[k][3], Is1[k][4])
				img2 = MPImodifiers.image_masks(Is1[k][1], Is1[k][0], Is1[k][2], Is1[k][3], Is1[k][4])
				img3 = MPImodifiers.image_masks(Is1[k][2], Is1[k][1], Is1[k][0], Is1[k][3], Is1[k][4])
				img4 = MPImodifiers.image_masks(Is1[k][3], Is1[k][1], Is1[k][2], Is1[k][0], Is1[k][4])
				img5 = MPImodifiers.image_masks(Is1[k][4], Is1[k][1], Is1[k][2], Is1[k][3], Is1[k][0])
		...
		for i in range(mult[j][1], mult[j][2]):
			...
			k = i - mult[j][1]
			if spot == 0:
				img1 = MPImodifiers.frame_differences(Is1[k][0], Is1[k][1], Is1[k][2], Is1[k][3], Is1[k][4])
				img2 = MPImodifiers.frame_differences(Is1[k][1], Is1[k][0], Is1[k][2], Is1[k][3], Is1[k][4])
				img3 = MPImodifiers.frame_differences(Is1[k][2], Is1[k][1], Is1[k][0], Is1[k][3], Is1[k][4])
				img4 = MPImodifiers.frame_differences(Is1[k][3], Is1[k][1], Is1[k][2], Is1[k][0], Is1[k][4])
				img5 = MPImodifiers.frame_differences(Is1[k][4], Is1[k][1], Is1[k][2], Is1[k][3], Is1[k][0])
			...
			pMap1 = FunctionalNetwork.F1(imgs[spot], networkS)
			if spot in [1, 2, 3, 4]:
				comm.send(pMap1, dest = 0)
			...
			(networkS, error) = FunctionalNetwork.BP(networkS, As1[i][spot], alpha, losses[-1], sMap4, sMap3, sMap2, sMap1)
