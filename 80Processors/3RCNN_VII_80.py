...
for j in range(len(mult)):
    ...
    #
        ...
        # this is the version with averaged feature maps
        
        (networkS, error) = FunctionalNetwork.BP(networkS, error, alpha, filter_matrix, maps, sMaps3, sMaps2, sMaps1, rank, rho)
    #
        if rank != 0:
