...
for j in range(len(mult)):
    ...
    for i in range(mult[j][1], mult[j][2]):
        ...
        if (rank % 5) == 0:
            ...
            pMaps = SNN.states(Is1[u], [pMap3A, pMapB, pMapC, pMapD, pMapE])
    ...
    #
        ...
        if (rank % 5) == 0:
            ...
            pMaps = SNN.states(Is1[u], [pMap3B, pMapB, pMapC, pMapD, pMapE])
    ...
    #
        ...
        if (rank % 5) == 0:
            ...
            pMaps = SNN.states(Is1[u], [pMap4A, pMapB, pMapC, pMapD, pMapE])
    ...
    #
        ...
        if (rank % 5) == 0:
            ...
            pMaps = SNN.states(Is1[u], [pMap4B, pMapB, pMapC, pMapD, pMapE])
        ...
        if (rank % 5) == 0:
            ...
            pMaps = SNN.states(Is1[u], [pMap4C, pMapB, pMapC, pMapD, pMapE])
    ...
    #
        ...
        if (rank % 5) == 0:
            ...
            pMaps = SNN.states(Is1[u], [pMap4D, pMapB, pMapC, pMapD, pMapE])
    ...
    #
        ...
        if (rank % 16) == 0:
            ...
            maps = MPImodifiers.afm(sMaps1, sMaps2, sMaps3, sMaps4)
        
            for k in range(1, 16):
                comm.send((networkS, error, filter_matrix, maps, sMaps3, sMaps2, sMaps1, rho), dest = rank + k)
        
        if (rank % 16) != 0:
            place = (rank // 16) * 16
            (networkS, error, filter_matrix, maps, sMaps3, sMaps2, sMaps1, rho) = comm.recv(source = place)
        print("bp")
        (networkS, error) = FunctionalNetwork.BP(networkS, error, alpha, filter_matrix, maps, sMaps3, sMaps2, sMaps1, rank, neurals[-1][rank // 16], psi, rho)
    #
        if rank != 0:
