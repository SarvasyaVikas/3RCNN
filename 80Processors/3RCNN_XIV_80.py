...
for j in range(len(mult)):
    ...
    for i in range(mult[j][1], mult[j][2]):
        ...
        if rank == 0:
		img1 = MPImodifiers.image_masks(Is1[u][0], Is1[u][1], Is1[u][2], Is1[u][3], Is1[u][4])
		img2 = MPImodifiers.image_masks(Is1[u][1], Is1[u][0], Is1[u][2], Is1[u][3], Is1[u][4])
		img3 = MPImodifiers.image_masks(Is1[u][2], Is1[u][1], Is1[u][0], Is1[u][3], Is1[u][4])
		img4 = MPImodifiers.image_masks(Is1[u][3], Is1[u][1], Is1[u][2], Is1[u][0], Is1[u][4])
		img5 = MPImodifiers.image_masks(Is1[u][4], Is1[u][1], Is1[u][2], Is1[u][3], Is1[u][0])
