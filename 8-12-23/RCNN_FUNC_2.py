...
def data(ptn):
    rows = []
    with open("REVALS_8_UPD_ANNO.csv") as csvfile:
...
class RCNN:
    ...
    def VR(rank, networkS, Is1, As1, mult, j, i, alpha, losses, minval, maxval, FOV, CACscore, start, CACactual, scan_start, nn, step, f, art, sMaps4):
